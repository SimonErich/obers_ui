...
class OiBubbleChartPainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    final chartRect = Rect.fromLTRB(pad, pad / 2, size.width - 8, size.height - pad);
  ...
  void _drawBubble(
    ...
    final borderPaint = Paint()
      ...
      ..style = PaintingStyle.stroke
      ..strokeWidth =
          isHovered ? bubble.borderWidth + 1.5 : (highContrast ? bubble.borderWidth + 1 : bubble.borderWidth);
