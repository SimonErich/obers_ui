...
class OiChartGridPainter extends OiChartLayerPainter {
  ...
  _ResolvedGridLine _resolveConfig(
    ...
    return _ResolvedGridLine(color: color, width: width, dash: config.dashPattern ?? themeGrid?.dashPattern);
  }

  void _paintHorizontalLines(
    Canvas canvas, Rect bounds, List<double> positions,
  ...
  static void _drawDashedLine(
    Canvas canvas, Offset start, Offset end,
