...
class OiChartMarker extends OiChartLayerPainter {
  ...
  void _paintMarker(Canvas canvas, Offset center, OiChartMarkerState state) {
    ...
    switch (style.shape) {
      case OiChartMarkerShape.circle:
        _paintCircle(
          canvas, center, halfSize, fillColor, strokeColor,
      ...
      case OiChartMarkerShape.cross:
        _paintCross(canvas, center, halfSize, strokeColor, effectiveStrokeWidth);
      case OiChartMarkerShape.custom:
        _paintCustom(
          canvas, center, effectiveSize, fillColor, strokeColor,
          effectiveStrokeWidth,
        );
    }
  }
  ...
  void _paintSquare(
    Canvas canvas, Offset center, double halfSize,
    Color? fill, Color? stroke, double strokeWidth,
  ) {
  ...
  void _paintCustom(
    Canvas canvas, Offset center, double size,
    Color? fill, Color? stroke, double strokeWidth,
  ) {
