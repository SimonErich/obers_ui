...
class OiColorScheme {
  ...
  ///
  /// Uses a blue primary, golden accent, and light grey surfaces.
  factory OiColorScheme.light() {
    return OiColorScheme(
      primary: OiColorSwatch.from(const Color(0xFF5BA4CF)),
      accent: OiColorSwatch.from(const Color(0xFFE8C84A)),
      success: OiColorSwatch.from(const Color(0xFF7BAF96)),
      warning: OiColorSwatch.from(const Color(0xFFE8A44C)),
      error: OiColorSwatch.from(const Color(0xFFC0724A)),
      info: OiColorSwatch.from(const Color(0xFF7B9DB8)),
      ...
      textSubtle: const Color(0xFF5A5A5A),
      ...
      borderFocus: const Color(0xFF5BA4CF),
      borderError: const Color(0xFFC0724A),
  ...
  ///
  /// Uses a blue primary, golden accent, and near-black surfaces.
  factory OiColorScheme.dark() {
    return OiColorScheme(
      primary: OiColorSwatch.from(const Color(0xFF7AB8E0)),
      accent: OiColorSwatch.from(const Color(0xFFF0D86A)),
      success: OiColorSwatch.from(const Color(0xFF92C4AA)),
      warning: OiColorSwatch.from(const Color(0xFFF0B86A)),
      error: OiColorSwatch.from(const Color(0xFFD48A66)),
      info: OiColorSwatch.from(const Color(0xFF96B4CA)),
      ...
      borderFocus: const Color(0xFF7AB8E0),
      borderError: const Color(0xFFD48A66),
