...
class OiThemeData {
  ...
  OiThemeData({
    ...
    this.monoFontFamily,
       ...
       iconSizes = iconSizes ?? const OiIconSizeScale.standard();
  ...
  /// The breakpoint scale defining responsive breakpoints.
  ///
  /// Defaults to [OiBreakpointScale.standard] (5-tier: compact, medium,
  /// expanded, large, extraLarge). Override with custom breakpoints to
  /// extend the responsive system.
  final OiBreakpointScale breakpoints;
  ...
  /// The icon-size ladder. Read by `OiIcon` when no explicit size is given.
  final OiIconSizeScale iconSizes;
  ...
  static OiThemeData lerp(OiThemeData a, OiThemeData b, double t) {
    ...
    return OiThemeData(
      ...
      iconSizes: t < 0.5 ? a.iconSizes : b.iconSizes,
