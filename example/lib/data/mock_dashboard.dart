...
final kMockOrders = <Map<String, Object>>[
  {
    ...
    'lineItems': <Map<String, Object>>[
      {
        'product': 'Original Sacher-Torte',
        'quantity': 1,
        'unitPrice': 38.90,
        'total': 38.90,
      },
      {
        'product': 'Mozartkugeln Gift Box (24 pcs)',
        'quantity': 2,
        'unitPrice': 29.90,
        'total': 59.80,
      },
  ...
  },
  {
    ...
    'lineItems': <Map<String, Object>>[
      {
        'product': 'Alpine Hiking Boot "Gipfelstürmer"',
        'quantity': 1,
        'unitPrice': 289.00,
        'total': 289.00,
      },
  ...
  },
  {
    ...
    'lineItems': <Map<String, Object>>[
      {
        'product': 'Viennese Coffee Set',
        'quantity': 1,
        'unitPrice': 64.90,
        'total': 64.90,
      },
      {
        'product': 'Almdudler Party Pack',
        'quantity': 2,
        'unitPrice': 18.90,
        'total': 37.80,
      },
      {
        'product': 'Zillertaler Graukäse',
        'quantity': 2,
        'unitPrice': 24.90,
        'total': 49.80,
      },
      {
        'product': 'Express Shipping',
        'quantity': 1,
        'unitPrice': 12.90,
        'total': 12.90,
      },
  ...
  },
  {
    ...
    'lineItems': <Map<String, Object>>[
      {
        'product': 'Wiener Schnitzel Home Kit',
        'quantity': 1,
        'unitPrice': 34.50,
        'total': 34.50,
      },
  ...
  },
  {
    ...
    'lineItems': <Map<String, Object>>[
      {
        'product': 'Lederhosen "Bergkönig"',
        'quantity': 1,
        'unitPrice': 189.00,
        'total': 189.00,
      },
      {
        'product': 'Dirndl "Almsommer"',
        'quantity': 1,
        'unitPrice': 159.00,
        'total': 159.00,
      },
  ...
  },
  {
    ...
    'lineItems': <Map<String, Object>>[
      ...
      {
        'product': 'Alm-Bote Mountain Courier',
        'quantity': 1,
        'unitPrice': 24.90,
        'total': 24.90,
      },
...
const kMockRoles =
    <({String key, String label, String description, int color})>[
      (
        key: 'admin',
        label: 'Administrator',
...
const kMockPermissions = <({String key, String label, String description})>[
  ...
  (
    key: 'orders.read',
    label: 'View Orders',
    description: 'See order list and details',
  ),
  (
    key: 'orders.write',
    label: 'Manage Orders',
...
final kMockPermissionMatrix = <String, Set<String>>{
  ...
  'viewer': {'users.read', 'orders.read', 'products.read', 'reports.read'},
  'support': {
    'users.read',
    'orders.read',
    'orders.write',
...
const kMockApiKeys = <({String name, String key, String created, bool active})>[
  (
    ...
    key: 'ak_prod_7f3b9c2e1a4d8f6b0e5c3a9d2f1b8e4a',
    created: '2025-11-15',
    active: true,
  ),
  (
    name: 'Staging API Key',
    key: 'ak_stg_2c4e8f1b9a3d7e5c0f6b2a8d4e1c9f3b',
    created: '2026-01-20',
    active: true,
  ),
  (
    name: 'Development API Key',
    key: 'ak_dev_9d1f3b7e2c5a8d4f0b6e3c9a1d8f2b5e',
    created: '2026-02-10',
    active: false,
  ),
];
...
const kAdminCommandEntries =
    <({String id, String label, String category, String? description})>[
      ...
      (
        ...
        label: 'Export Users',
        category: 'Actions',
        description: 'Download employee CSV',
      ),
      (
        id: 'act-export-orders',
        label: 'Export Orders',
        category: 'Actions',
        description: 'Download orders CSV',
      ),
      (
        id: 'act-new-user',
