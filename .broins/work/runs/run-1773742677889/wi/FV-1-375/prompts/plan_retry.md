CRITICAL RECOVERY (attempt 2 of 3): Previous attempts produced NO output. Respond with ONLY the plan. Start with "## Plan". At minimum list the files to modify and one sub-task per atom:
