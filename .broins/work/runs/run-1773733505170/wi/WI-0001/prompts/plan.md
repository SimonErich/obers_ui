...
- **WI-0001-Q001**: How should "**OiImage** requires `alt`. Use `OiImage.decorative()` to explicitly opt out." be verified? No acceptance hints were provided. → _(no answer)_
- **WI-0001-Q002**: How should "**OiButton** (all variants including `.icon()`) requires `label`." be verified? No acceptance hints were provided. → _(no answer)_
- **WI-0001-Q003**: How should "**OiIcon** requires `label`. Use `OiIcon.decorative()` to opt out." be verified? No acceptance hints were provided. → _(no answer)_
