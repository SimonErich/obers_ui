...
- **WI-0064-Q001**: How should "Name by what it _is_ in the UI. `OiTable`, `OiButton`, `OiSidebar`." be verified? No acceptance hints were provided. → _(no answer)_
- **WI-0064-Q002**: How should "Props read like English. `multiSelect: true`, `reorderColumns: true`, `stickyHeader: true`." be verified? No acceptance hints were provided. → _(no answer)_
- **WI-0064-Q003**: How should "Required props enforce correctness. Images require `alt`, buttons require `label`." be verified? No acceptance hints were provided. → _(no answer)_
