...
void main() {
  ...
  testWidgets('renders without errors', (tester) async {
    await tester.pumpChartApp(_heatmap());
  ...
  testWidgets('onCellTap fires with correct cell', (tester) async {
    ...
    await tester.pumpChartApp(_heatmap(onCellTap: (cell) => tappedCell = cell));
  ...
  testWidgets('handles empty cells gracefully', (tester) async {
    await tester.pumpChartApp(_heatmap(cells: const []));
    expect(find.byType(OiHeatmap), findsOneWidget);
  ...
  testWidgets('has semantics label', (tester) async {
    await tester.pumpChartApp(_heatmap(label: 'Activity Map'));
  ...
  testWidgets('hides values when showValues is false', (tester) async {
    await tester.pumpChartApp(_heatmap(showValues: false));
  ...
  testWidgets('renders with custom minValue and maxValue', (tester) async {
    await tester.pumpChartApp(_heatmap(minValue: 0, maxValue: 200));
    expect(find.byType(OiHeatmap), findsOneWidget);
  });
