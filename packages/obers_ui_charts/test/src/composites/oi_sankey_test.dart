...
import 'package:obers_ui_charts/src/composites/oi_sankey.dart';
...
void main() {
  ...
  testWidgets('onNodeTap fires with correct node', (tester) async {
    ...
    await tester.pumpChartApp(_sankey(onNodeTap: (node) => tappedNode = node));
  ...
  testWidgets('handles empty nodes gracefully', (tester) async {
    await tester.pumpChartApp(_sankey(nodes: const [], links: const []));
    expect(find.byType(OiSankey), findsOneWidget);
  ...
  testWidgets('has semantics label', (tester) async {
    await tester.pumpChartApp(_sankey(label: 'Energy Flow'));
  ...
  testWidgets('hides labels when showLabels is false', (tester) async {
    await tester.pumpChartApp(_sankey(showLabels: false));
  ...
  testWidgets('shows values when showValues is true', (tester) async {
    await tester.pumpChartApp(_sankey(showValues: true));
