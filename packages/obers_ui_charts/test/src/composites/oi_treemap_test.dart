...
import 'package:obers_ui_charts/src/composites/oi_treemap.dart';
...
void main() {
  ...
  testWidgets('renders without errors', (tester) async {
    await tester.pumpChartApp(_treemap());
  ...
  testWidgets('onNodeTap fires with correct node', (tester) async {
    ...
    await tester.pumpChartApp(_treemap(onNodeTap: (node) => tappedNode = node));
  ...
  testWidgets('handles empty nodes gracefully', (tester) async {
    await tester.pumpChartApp(_treemap(nodes: const []));
    expect(find.byType(OiTreemap), findsOneWidget);
  ...
  testWidgets('has semantics label', (tester) async {
    await tester.pumpChartApp(_treemap(label: 'Disk Usage'));
  ...
  testWidgets('shows values when showValues is true', (tester) async {
    await tester.pumpChartApp(_treemap(showValues: true));
  ...
  testWidgets('hides labels when showLabels is false', (tester) async {
    await tester.pumpChartApp(_treemap(showLabels: false));
