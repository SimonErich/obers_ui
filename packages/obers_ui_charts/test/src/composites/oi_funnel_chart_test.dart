...
import 'package:obers_ui_charts/src/composites/oi_funnel_chart.dart';
...
void main() {
  ...
  testWidgets('renders without errors', (tester) async {
    await tester.pumpChartApp(_funnelChart());
  ...
  testWidgets('handles empty stages gracefully', (tester) async {
    await tester.pumpChartApp(_funnelChart(stages: const []));
    expect(find.byType(OiFunnelChart), findsOneWidget);
  ...
  testWidgets('has semantics label', (tester) async {
    await tester.pumpChartApp(_funnelChart(label: 'Sales Funnel'));
  ...
  testWidgets('shows only percentages when showValues is false', (
    ...
    await tester.pumpChartApp(_funnelChart(showValues: false));
