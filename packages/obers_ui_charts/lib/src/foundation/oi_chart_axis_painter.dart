...
class OiChartAxisPainter extends OiChartLayerPainter {
  ...
  void paint(OiChartCanvasContext context) {
    ...
    final resolvedLineColor =
        lineColor ?? themeAxis?.lineColor ?? _fallbackColor;
    final resolvedLineWidth =
        lineWidth ?? themeAxis?.lineWidth ?? _fallbackLineWidth;
    final resolvedTickColor =
        tickColor ?? themeAxis?.tickColor ?? resolvedLineColor;
    final resolvedTickLength =
        tickLength ?? themeAxis?.tickLength ?? _fallbackTickLength;
    final resolvedTickWidth =
        tickWidth ?? themeAxis?.tickWidth ?? _fallbackTickWidth;
...
class OiChartLabelPainter extends OiChartLayerPainter {
  ...
  TextStyle _resolveStyle() {
    var style =
        labelStyle ?? themeAxis?.labelStyle ?? const TextStyle(fontSize: 11);
