...
import 'package:obers_ui/src/composites/visualization/oi_bubble_chart/oi_bubble_chart.dart';
...
void main() {
  ...
  testWidgets('renders without errors', (tester) async {
    await tester.pumpObers(_bubbleChart());
  ...
  testWidgets('legend displays series names', (tester) async {
    await tester.pumpObers(_bubbleChart(data: _multiSeriesData()));
  ...
  testWidgets('label alias provides semantics', (tester) async {
    await tester.pumpObers(_bubbleChart(label: 'My Chart'));
    final semantics = tester.getSemantics(find.byType(OiBubbleChart));
  ...
  group('REQ-0139 Responsive', () {
    testWidgets('compact layout uses fewer grid lines', (tester) async {
      await tester.pumpObers(_bubbleChart(compact: true, width: 300));
    ...
    testWidgets('non-compact layout uses full grid lines', (tester) async {
      await tester.pumpObers(_bubbleChart(compact: false, width: 600));
